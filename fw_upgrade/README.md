...
def encrypt(in_file, out_file):
   bs = AES.block_size
   key = b"\xED\xD9\x5F\x33\x63\x4A\xCD\x7F\x9D\x2C\x16\x6B\x34\x78\x61\xE1\xB6\x27\xD0\x28\xBC\x27\x11\x8A\x0D\x40\xF4\xA9\x49\xEF\x02\x9F"
   iv = b"\xB8\x4F\x1D\xB1\xD3\x7C\x1B\x3B\x7C\x08\x90\xE8\xDF\x8C\xB4\xDB"
   cipher = AES.new(key, AES.MODE_CBC, iv)
   finished = False
